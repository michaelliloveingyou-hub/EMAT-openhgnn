...
lisan_hgb_datasets = ['lisan-acm', 'lisan-dblp']
...
#####################     add dataset here
        ...
        return DATASET_REGISTRY[_dataset](dataset, logger=kwargs['logger'],args = kwargs['args'])
    elif dataset in lisan_hgb_datasets:
        _dataset = 'lisan_hgb_' + task
        return DATASET_REGISTRY[_dataset](dataset, logger=kwargs['logger'], args=kwargs['args'])
######################
...
from .lisan_hgb_dataset import LisanHGBNodeClassification, LisanHGBLinkPrediction
